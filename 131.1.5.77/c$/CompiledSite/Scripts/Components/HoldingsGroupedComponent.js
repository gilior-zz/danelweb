...
(function (Danel) {
    var DanelHoldingsGroupedCtrl = (function (_super) {
        ...
        function DanelHoldingsGroupedCtrl($scope, holdingsStore) {
            _super.call(this, "DanelHoldingsGroupedCtrl", $scope);
            var me = this;
        ...
        DanelHoldingsGroupedCtrl.prototype.linkToFunds = function () {
            ...
            if (me.homePageLink == undefined) {
                me.parametersService.GetDanelParameter(Danel.WebParameter.LinkToHomePageForFunds + Danel.WebParameter.CompanyWebsiteLink).then(function (res) {
                    me.linkToHomePageForFunds = res.ParameterItems[1].Value.toLowerCase() == 'true';
                    if (!me.linkToHomePageForFunds)
                        return;
                    me.homePageLink = res.ParameterItems[0].Value;
