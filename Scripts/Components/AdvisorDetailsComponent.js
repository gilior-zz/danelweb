...
(function (Danel) {
    var AdvisorDetailsCtrl = (function (_super) {
        ...
        function AdvisorDetailsCtrl($scope) {
            var _this = _super.call(this, 'AdvisorDetailsCtrl', $scope) || this;
            var me = _this;
            ...
            me.allowWebMessageToAdvisor = me.parametersService.GetDanelParameter(Danel.WebParameter.AllowWebMessageToAdvisor).toLowerCase() == 'true' && me.authService.isLoggedIn();
            return _this;
        }
