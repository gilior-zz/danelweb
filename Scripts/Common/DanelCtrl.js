...
(function (Danel) {
    var DanelCtrl = (function (_super) {
        ...
        function DanelCtrl(name, $scope) {
            var _this = _super.call(this, name, $scope) || this;
            var me = _this;
            ...
            me.applyChanges(function () {
                me.mainColor = me.parametersService.GetDanelParameter(Danel.WebParameter.WebsiteMainColor);
                me.headerAndTotalColor = me.parametersService.GetDanelParameter(Danel.WebParameter.HeaderAndTotalColor);
